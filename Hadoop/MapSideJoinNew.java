...
public class MapSideJoinNew {
	...
	extends Mapper<LongWritable, Text, Text, Text>{
		...
		public void map(LongWritable key, Text value, Context context) throws IOException, InterruptedException {
			...
			String user1 = context.getConfiguration().get("userA");
			String user2 = context.getConfiguration().get("userB");
			
			if (mydata.length > 1) {
//				String[] ids = mydata[0].split(",");
//				System.out.println(mydata[0]);
				if(mydata[0].equals(user1)||mydata[0].equals(user2)) {
//					System.out.println("test");
	...
	// Driver program
		public static void main(String[] args) throws Exception {
			...
			job.setJarByClass(MapSideJoinNew.class);
			...
			job2.setJarByClass(MapSideJoinNew.class);
